...
func (r pgProductRepository) Create(product *model.Product) (*model.Product, error) {
	err := r.db.Create(product).Error
	return product, err
}

func (r pgProductRepository) GetByID(id string) (*model.Product, error) {
...
func (r pgProductRepository) GetByFacilityID(facilityID string, order *model.QueryOrder, pagination model.Pagination) ([]model.Product, int, error) {
...
func (r pgProductRepository) Delete(productID string) error {
...
func (r pgProductRepository) Update(product model.Product) (*model.Product, error) {
